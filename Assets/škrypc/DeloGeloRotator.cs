...
public class DeloGeloRotator : MonoBehaviour {
		...
		void FixedUpdate () 
		{
		   ...
		   // float targetRotation = ( 1.5, 1.5, 3.5 );
			...
			// Clamp the X value
			clampedRotation.y = Mathf.Clamp(clampedRotation.y, minAngle, maxAngle);
